 ...
 * Based on the QTouch ADC implementation
 * **************************************
 * Using Arduino's ADC to detect touch
 * The main advantages are:
 * -->Simple Hardware Setup
 * --> One-wire/Single IO (leaving more IOs for you to play with)
...
#define TPIN1 2
#define TPIN2 3 // this is currently only used as a supply of Vcc to charge the s&h cap
...
void loop() {
  ...
  // FRED // Serial.print(time);
  // FRED // Serial.print('|');
  Serial.print(adc1);
  // FRED // Serial.print('|');
  Serial.print(" | "); // FRED //
  Serial.println(adc2); // FRED - change back to PRINT from LN //
  // FRED // Serial.print('|');
  // FRED // Serial.print(probe_val);
  // FRED // Serial.print('|');
  // FRED // Serial.println(idx);
